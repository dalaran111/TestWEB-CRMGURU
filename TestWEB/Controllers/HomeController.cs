...
namespace TestWEB.WebUI.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public HomeController(CityRepository cityRepo, CountryRepository countryRepo, RegionRepository regionRepo)
        {
