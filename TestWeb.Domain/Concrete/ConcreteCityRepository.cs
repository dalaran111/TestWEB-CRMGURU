...
namespace TestWeb.Domain.Concrete
{
    ...
    /// </summary>
    public class ConcreteCityRepository : CityRepository
    {
        /// <summary>
        ...
        public ConcreteCityRepository(string conn) => _connectionString = conn;
        /// <summary>
        ...
        public List<City> GetCities()
        {
            ...
            {
                ExceptionMessage.ShowMessage("City", "GetCities", ex);
                return null;
            }
        }
        /// <summary>
        ...
        public City GetCityById(int cityId)
        {
            ...
            {
                ExceptionMessage.ShowMessage("City", "GetCityById", ex);
                return null;
            }
        }
        /// <summary>
        ...
        public City GetCityByName(string cityName)
        {
            ...
            {
                ExceptionMessage.ShowMessage("City", "GetCityByName", ex);
                return null;
            }
        }
        /// <summary>
        ...
        public void AddCity(City city)
        {
            ...
            {
                ExceptionMessage.ShowMessage("City", "AddCity", ex);
            }
        }
        /// <summary>
        ...
        public string CheckExistCity(string cityName)
        {
            ...
            {
                ExceptionMessage.ShowMessage("City", "CheckExistCity", ex);
                return null;
            }
        }
    }
