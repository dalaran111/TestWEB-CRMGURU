...
using TestWeb.Domain.ExceptionHandlers;
using Dapper;

namespace TestWeb.Domain.Concrete
{
    /// <summary>
    /// Country repository implementing the corresponding interface
    /// </summary>
    public class ConcreteCountryRepository : CountryRepository
    {
        /// <summary>
        ...
        public ConcreteCountryRepository(string conn) => _connectionString = conn;
        /// <summary>
        ...
        public List<Country> GetCountries()
        {
            ...
            {
                ExceptionMessage.ShowMessage("Country", "GetCountries", ex);
                return null;
            }
        }
        /// <summary>
        ...
        public Country GetCountryByName(string countryName)
        {
            ...
            {
                ExceptionMessage.ShowMessage("Country", "GetCountryByName", ex);
                return null;
            }
        }
        /// <summary>
        ...
        public void AddCountry(Country country, string capitalName, string regionName)
        {
            ...
            {
                ExceptionMessage.ShowMessage("Country", "AddCountry", ex);
            }
        }
        /// <summary>
        ...
        public void UpdateCountry(Country country, string capitalName, string regionName)
        {
            ...
            {
                ExceptionMessage.ShowMessage("Country", "UpdateCountry", ex);
            }
        }
        /// <summary>
        ...
        public string CheckExistCountry(string countryCode)
        {
            ...
            {
                ExceptionMessage.ShowMessage("Country", "CheckExistCountry", ex);
                return null;
            }
        }
    }
