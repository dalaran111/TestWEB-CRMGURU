...
namespace TestWeb.Domain.Concrete
{
    ...
    /// </summary>
    public class ConcreteRegionRepository : RegionRepository
    {
        /// <summary>
        ...
        public ConcreteRegionRepository(string conn) => _connectionString = conn;
        /// <summary>
        ...
        public List<Region> GetRegions()
        {
            ...
            {
                ExceptionMessage.ShowMessage("Region", "GetRegions", ex);
                return null;
            }
        }
        /// <summary>
        ...
        public Region GetRegionById(int regionId)
        {
            ...
            {
                ExceptionMessage.ShowMessage("Region", "GetRegionById", ex);
                return null;
            }
        }
        /// <summary>
        ...
        public Region GetRegionByName(string regionName)
        {
            ...
            {
                ExceptionMessage.ShowMessage("Region", "GetRegionByName", ex);
                return null;
            }
        }
        /// <summary>
        ...
        public void AddRegion(Region region)
        {
            ...
            {
                ExceptionMessage.ShowMessage("Region", "AddRegion", ex);
            }
        }
        /// <summary>
